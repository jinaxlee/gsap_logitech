window.addEventListener("DOMContentLoaded", function () {
  ...
  gsap.to("#section05 .page03 .txt", {
    ...
    scrollTrigger: {
      trigger: "#section05",
      start: () => "+=" + innerHeight * 1.5, // 화면 높이 길이의 하나 반 만큼 이동,
      end: "bottom bottom",
      scrub: true,
      // markers: true,
    },
  ...
  // section 06 title image move animation
  ...
  gsap.to("#section07 .side", {
    scrollTrigger: {
      ...
      // onEnterBack: () => { // 스크롤이 트리거 요소의 시작 위치에 역방향으로 도달했을 때
      //   $("#section07 .side").addClass("on");
      // },
      // onLeave: () => { // 스크롤이 트리거 요소의 끝 위치를 지났을 때
      //   $("#section07 .side").removeClass("on");
      // },
      onLeaveBack: () => {
  ...
  animateTextSec10("3300", "#section10 .page05 .container01 .title");
  animateTextSec10("3900", "#section10 .page05 .container02 .title");
  animateTextSec10("4500", "#section10 .page05 .container03 .title");
